...
-- -----------------------------------------------------
-- Table `persons_phones`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `persons_phones` (
...
-- -----------------------------------------------------
-- Table `persons_credits`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `persons_credits` (
...
-- -----------------------------------------------------
-- Table `persons_inventory_times`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `persons_inventory_times` (
...
-- Table `drawers_times`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drawers_times` (
...
-- Table `persons_times`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `persons_times` (
...
-- -----------------------------------------------------
-- Table `credit_card_readers`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `credit_card_readers` (
...
-- -----------------------------------------------------
-- Table `drawers_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drawers_locations` (
...
-- Table `stores_phones`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `stores_phones` (
...
-- -----------------------------------------------------
-- Table `kiosks_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kiosks_locations` (
...
-- -----------------------------------------------------
-- Table `printers_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `printers_locations` (
...
-- -----------------------------------------------------
-- Table `credit_card_readers_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `credit_card_readers_locations` (
  ...
  CONSTRAINT `ccrl_credit_card_reader_id`
    ...
    REFERENCES `credit_card_readers` (`credit_card_reader_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `scanners_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `scanners_locations` (
  ...
  CONSTRAINT `scl_scanner_id`
    ...
    REFERENCES `scanners` (`scanner_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `repairs_statuses`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `repairs_statuses` (
...
CREATE  TABLE IF NOT EXISTS `repairs` (
  ...
  CONSTRAINT `repair_status_id`
    ...
    REFERENCES `repairs_statuses` (`repair_status_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `persons_repairs_times`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `persons_repairs_times` (
...
-- -----------------------------------------------------
-- Table `repairs_persons_messages`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `repairs_persons_messages` (
  ...
  CONSTRAINT `rpm_pm_sender_person_id`
    ...
    REFERENCES `persons_messages` (`pm_sender_person_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `rpm_pm_receiver_person_id`
    FOREIGN KEY (`rpm_pm_receiver_person_id` )
    REFERENCES `persons_messages` (`pm_receiver_person_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `rpm_pm_message_id`
    FOREIGN KEY (`rpm_pm_message_id` )
    REFERENCES `persons_messages` (`pm_message_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `items_pieces`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `items_pieces` (
...
-- -----------------------------------------------------
-- Table `pieces_attributes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `pieces_attributes` (
...
-- -----------------------------------------------------
-- Table `scanners_scans`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `scanners_scans` (
...
-- -----------------------------------------------------
-- Table `inventory_stores_locations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `inventory_stores_locations` (
  ...
  CONSTRAINT `isl_store_id`
    ...
    REFERENCES `stores_locations` (`sl_store_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `isl_location_id`
    FOREIGN KEY (`isl_location_id` )
    REFERENCES `stores_locations` (`sl_location_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
